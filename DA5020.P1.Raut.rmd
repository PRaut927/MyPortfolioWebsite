...
We'll be working with a sample of <a href="ftp://ftp.ncbi.nlm.nih.gov/pubmed/baseline-2018-sample/" target="_blank">MEDLINE/PubMed</a> publication data obtained from the National Institute of Health (NIH) [website](https://www.nlm.nih.gov/databases/download/pubmed_medline.html).
